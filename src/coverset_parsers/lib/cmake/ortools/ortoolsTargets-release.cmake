...
set_target_properties(ortools::ortools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libortools.so.9.5.2237"
  IMPORTED_SONAME_RELEASE "libortools.so.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS ortools::ortools )
list(APPEND _IMPORT_CHECK_FILES_FOR_ortools::ortools "${_IMPORT_PREFIX}/lib/libortools.so.9.5.2237" )
...
set_target_properties(ortools::flatzinc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libortools_flatzinc.so.9.5.2237"
  IMPORTED_SONAME_RELEASE "libortools_flatzinc.so.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS ortools::flatzinc )
list(APPEND _IMPORT_CHECK_FILES_FOR_ortools::flatzinc "${_IMPORT_PREFIX}/lib/libortools_flatzinc.so.9.5.2237" )
