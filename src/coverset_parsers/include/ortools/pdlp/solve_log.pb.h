...
public:
  ...
  explicit PROTOBUF_CONSTEXPR IterationStats_MethodSpecificStatsEntry_DoNotUse(
...
inline int IterationStats::_internal_method_specific_stats_size() const {
  return _impl_.method_specific_stats_.size();
}
...
IterationStats::_internal_mutable_method_specific_stats() {
  return _impl_.method_specific_stats_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, double >*
