...
def run_exp(track, mult, species_to_try):
    ...
    # Configure.
    new_exp_name = f'{track}{mult}_{len(species_to_try)}_species_preclustering'
    context = {
    ...
    # Run ALLEGRO.
    os.system('python src/main.py --config ' + config_name + ' -od data/output/species_increments_preclustering --align_solution_to_input False')
