...
# Introduction
ALLEGRO (_<ins>Al</ins>gorithm for a <ins>L</ins>inear program <ins>E</ins>nabling <ins>G</ins>uide <ins>R</ins>NA <ins>O</ins>ptimization_) is a synthetic biology tool leveraging linear programming to design the smallest possible gRNA library to fulfill user-specified constraints.
